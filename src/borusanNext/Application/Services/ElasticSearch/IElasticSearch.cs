...
namespace Application.Services.ElasticSearch;
public interface IElasticSearch
{
    ...
    Task<List<ElasticSearchGetModel<T>>> GetSearchBySimpleQueryString<T>(Common.Persistance.Elastic.Models.SearchByQueryParameters queryParameters) where T : class;
