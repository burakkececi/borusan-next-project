...
public class JwtHelper<TOperationClaimId, TRefreshTokenId> : ITokenHelper<TOperationClaimId, TRefreshTokenId>
{
    ...
    public virtual AccessToken CreateToken(User user, IList<OperationClaim<TOperationClaimId>> operationClaims)
    {
    ...
    public RefreshToken<TRefreshTokenId, Guid> CreateRefreshToken(User user, string ipAddress)
    {
        return new RefreshToken<TRefreshTokenId, Guid>
        {
            UserId = user.Id,
    ...
    public virtual JwtSecurityToken CreateJwtSecurityToken(TokenOptions tokenOptions, User user, SigningCredentials signingCredentials, IList<OperationClaim<TOperationClaimId>> operationClaims, DateTime accessTokenExpiration)
    {
    ...
    protected virtual IEnumerable<Claim> SetClaims(User user, IList<OperationClaim<TOperationClaimId>> operationClaims)
    {
