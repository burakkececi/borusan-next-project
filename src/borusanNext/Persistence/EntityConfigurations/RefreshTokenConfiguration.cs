...
public class RefreshTokenConfiguration : IEntityTypeConfiguration<RefreshToken>
{
    public void Configure(EntityTypeBuilder<RefreshToken> builder)
    {
        ...
        builder.Property(rt => rt.CreatedDate).HasColumnName("CreatedDate").HasColumnType("timestamp").IsRequired();
        builder.Property(rt => rt.UpdatedDate).HasColumnName("UpdatedDate").HasColumnType("timestamp");
        builder.Property(rt => rt.DeletedDate).HasColumnName("DeletedDate").HasColumnType("timestamp");
