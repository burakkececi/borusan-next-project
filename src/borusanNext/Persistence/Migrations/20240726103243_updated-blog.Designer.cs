...
namespace Persistence.Migrations
{
    ...
    [Migration("20240726103243_updated-blog")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("aec28949-414d-47a0-b3b5-13c6848de1e4"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            PasswordHash = new byte[] { 173, 140, 241, 91, 136, 3, 101, 145, 147, 233, 94, 233, 250, 57, 174, 226, 17, 191, 224, 153, 10, 8, 208, 224, 171, 9, 43, 22, 44, 31, 113, 80, 132, 0, 216, 225, 127, 75, 136, 225, 42, 133, 77, 181, 128, 105, 189, 252, 214, 230, 238, 208, 55, 198, 72, 253, 69, 11, 150, 113, 103, 159, 250, 65 },
                            PasswordSalt = new byte[] { 224, 217, 115, 253, 47, 218, 34, 99, 90, 175, 92, 197, 31, 67, 109, 138, 190, 173, 25, 75, 15, 183, 199, 65, 214, 105, 106, 223, 9, 99, 74, 3, 93, 97, 216, 111, 131, 142, 96, 159, 44, 13, 21, 24, 140, 161, 153, 121, 149, 140, 161, 134, 126, 128, 85, 89, 116, 52, 179, 84, 142, 72, 255, 221, 89, 131, 89, 66, 0, 108, 83, 14, 236, 149, 163, 175, 227, 113, 159, 74, 84, 104, 213, 188, 183, 48, 34, 242, 235, 255, 187, 33, 132, 203, 66, 87, 43, 34, 233, 151, 239, 151, 128, 102, 229, 186, 78, 176, 125, 67, 190, 40, 222, 62, 57, 104, 237, 72, 62, 249, 128, 81, 79, 200, 231, 57, 44, 186 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3c131ffa-f05d-4c03-b25a-d937ca94c8a7"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("aec28949-414d-47a0-b3b5-13c6848de1e4")
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Car", b =>
                {
                    b.HasOne("Domain.Entities.Advert", "Advert")
                        .WithOne("Car")
                        .HasForeignKey("Domain.Entities.Car", "AdvertId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
