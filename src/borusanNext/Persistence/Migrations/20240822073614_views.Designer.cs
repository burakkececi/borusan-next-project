...
namespace Persistence.Migrations
{
    ...
    [Migration("20240822073614_views")]
    partial class views
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("20021ebd-8c68-445f-aae6-4594b21a7c46"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@borusan.com",
                            PasswordHash = new byte[] { 25, 234, 134, 123, 13, 6, 200, 234, 232, 170, 218, 128, 2, 253, 161, 26, 85, 97, 33, 253, 180, 16, 124, 230, 124, 44, 183, 244, 233, 249, 189, 213, 139, 60, 198, 185, 162, 209, 130, 203, 113, 146, 108, 160, 224, 55, 57, 137, 220, 68, 203, 130, 124, 226, 252, 27, 215, 190, 219, 163, 151, 46, 27, 40 },
                            PasswordSalt = new byte[] { 208, 202, 206, 22, 125, 26, 143, 65, 148, 198, 140, 6, 83, 21, 125, 175, 179, 175, 92, 202, 170, 150, 23, 240, 31, 64, 18, 116, 11, 138, 9, 133, 178, 103, 73, 22, 118, 220, 43, 203, 145, 120, 78, 159, 220, 111, 186, 232, 170, 64, 10, 105, 132, 146, 189, 141, 230, 82, 185, 81, 154, 137, 109, 69, 150, 150, 18, 47, 50, 31, 201, 26, 59, 135, 113, 7, 192, 222, 122, 89, 32, 245, 58, 94, 139, 136, 74, 250, 77, 55, 169, 103, 75, 65, 178, 4, 124, 8, 168, 5, 101, 96, 36, 121, 181, 58, 71, 107, 178, 97, 226, 117, 40, 208, 187, 189, 201, 156, 191, 95, 200, 188, 160, 47, 178, 75, 134, 37 }
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("efc0eb49-205a-43d2-b5c4-4be65ad6acad"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("20021ebd-8c68-445f-aae6-4594b21a7c46")
                        });
                });
