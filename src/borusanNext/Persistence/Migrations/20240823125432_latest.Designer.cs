...
namespace Persistence.Migrations
{
    ...
    [Migration("20240823125432_latest")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cb72bc53-4095-42e6-a158-ee2fabebfc30"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@borusan.com",
                            PasswordHash = new byte[] { 12, 0, 222, 42, 60, 56, 3, 154, 52, 233, 218, 245, 241, 246, 222, 120, 69, 180, 79, 1, 45, 18, 201, 12, 247, 166, 72, 130, 220, 210, 76, 15, 185, 41, 42, 136, 171, 95, 246, 99, 132, 231, 225, 121, 71, 154, 109, 110, 212, 204, 39, 205, 152, 107, 80, 49, 187, 236, 133, 143, 174, 57, 106, 44 },
                            PasswordSalt = new byte[] { 171, 242, 187, 121, 229, 66, 103, 182, 229, 240, 227, 173, 131, 93, 217, 68, 197, 54, 233, 168, 40, 249, 236, 159, 225, 114, 134, 43, 75, 169, 81, 234, 30, 187, 19, 107, 248, 1, 156, 14, 208, 138, 34, 52, 32, 30, 193, 196, 45, 169, 144, 115, 254, 46, 34, 81, 75, 99, 203, 14, 117, 195, 228, 19, 66, 143, 217, 134, 56, 179, 157, 91, 15, 240, 221, 242, 152, 132, 176, 237, 86, 104, 252, 129, 140, 179, 227, 119, 47, 198, 23, 82, 176, 223, 102, 186, 235, 135, 35, 87, 204, 230, 235, 50, 130, 80, 11, 173, 80, 10, 250, 126, 172, 56, 203, 128, 53, 219, 87, 155, 183, 139, 48, 48, 9, 123, 149, 87 }
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d9a4aff6-9c81-45d7-ace0-4a1c2d4a2d2e"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("cb72bc53-4095-42e6-a158-ee2fabebfc30")
                        });
                });
