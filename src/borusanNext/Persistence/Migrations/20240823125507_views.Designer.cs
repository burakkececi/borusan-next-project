...
namespace Persistence.Migrations
{
    ...
    [Migration("20240823125507_views")]
    partial class views
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e569b1ff-c7be-4fba-a991-623cd615ec1d"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@borusan.com",
                            PasswordHash = new byte[] { 46, 178, 0, 123, 7, 53, 67, 127, 154, 155, 255, 147, 242, 211, 16, 74, 183, 20, 17, 62, 196, 135, 166, 233, 29, 249, 2, 120, 197, 51, 183, 119, 161, 32, 155, 198, 101, 127, 228, 157, 135, 151, 96, 152, 149, 32, 151, 49, 46, 187, 1, 21, 78, 184, 65, 65, 138, 165, 200, 245, 1, 13, 166, 155 },
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("05e060e8-3f90-4089-9304-f98fcde2da09"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("e569b1ff-c7be-4fba-a991-623cd615ec1d")
                        });
                });
