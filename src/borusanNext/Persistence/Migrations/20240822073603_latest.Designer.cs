...
namespace Persistence.Migrations
{
    ...
    [Migration("20240822073603_latest")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f626ed3d-5324-4dcd-844b-e9167c5e7a34"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin@borusan.com",
                            PasswordHash = new byte[] { 5, 69, 51, 39, 8, 217, 21, 205, 136, 82, 170, 31, 71, 133, 164, 233, 27, 25, 30, 4, 254, 103, 145, 180, 5, 167, 149, 105, 141, 220, 130, 194, 147, 120, 22, 233, 118, 140, 57, 185, 150, 201, 229, 62, 67, 221, 254, 189, 103, 49, 19, 161, 84, 13, 201, 177, 107, 122, 11, 69, 38, 100, 42, 83 },
                            PasswordSalt = new byte[] { 97, 72, 138, 232, 213, 8, 43, 100, 152, 59, 200, 207, 125, 224, 169, 227, 126, 79, 248, 122, 39, 51, 200, 143, 86, 33, 30, 226, 185, 84, 181, 223, 246, 55, 127, 121, 250, 192, 77, 38, 58, 237, 102, 105, 88, 135, 109, 30, 152, 44, 12, 252, 107, 98, 45, 62, 102, 207, 240, 113, 40, 57, 118, 53, 190, 124, 73, 141, 20, 118, 167, 172, 218, 62, 185, 118, 206, 253, 1, 103, 84, 99, 117, 208, 149, 130, 95, 86, 202, 1, 240, 239, 128, 216, 64, 46, 87, 45, 67, 228, 31, 85, 239, 172, 241, 117, 112, 153, 53, 87, 73, 228, 88, 156, 63, 67, 247, 46, 54, 93, 104, 23, 123, 153, 117, 105, 178, 65 }
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("878ab7a5-2f51-44ad-9a7e-12490985862d"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("f626ed3d-5324-4dcd-844b-e9167c5e7a34")
                        });
                });
