...
public class BrandsController : BaseController
{
    ...
    [HttpPost("GetDynamic")]
    public async Task<ActionResult<GetListResponse<GetDynamicBrandResponse>>> GetDynamic([FromBody] DynamicQuery dynamicQuery, [FromQuery] PageRequest pageRequest)
    {
